...
if "%COMMAND%" == "" (
    rem     rem Customized for SOF Container Server
...
:console
if "%DEBUG%" == "-debug" (
	%JAVA_HOME%\bin\java %JAVA_OPTS% %JPDA_OPTS% %APP_ARGS% -cp %CLASSPATH% com.ly.sof.core.DefaultBootstrap.DefaultBootstrap
) else (
    %JAVA_HOME%\bin\java %JAVA_OPTS% %APP_ARGS% -cp %CLASSPATH% com.ly.sof.core.DefaultBootstrap.DefaultBootstrap
)
goto :eof

:start
if "%DEBUG%" == "-debug" (
	start "" /MIN %JAVA_HOME%\bin\java %JAVA_OPTS% %JPDA_OPTS% %APP_ARGS% -cp %CLASSPATH% com.ly.sof.core.DefaultBootstrap.DefaultBootstrap
) else (
    start "" /MIN %JAVA_HOME%\bin\java %JAVA_OPTS% %APP_ARGS% -cp %CLASSPATH% com.ly.sof.core.DefaultBootstrap.DefaultBootstrap
)
goto :eof

:stop
%JAVA_HOME%\bin\java %JAVA_OPTS% -cp %CLASSPATH% com.ly.sof.core.DefaultBootstrap.DefaultBootstrap
goto :eof
