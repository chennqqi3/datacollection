 ...
 */
package com.ly.report.tmc.datacollectionapi.web.controller.error;
...
public class WebErrorFactory extends AbstractErrorFactory {
    ...
    private static final class AirErrorFactoryHolder {
        /** instance */
        private static final WebErrorFactory INSTANCE = new WebErrorFactory();
    }
     ...
     * @return
     */
    public LYError StartError(String message) {
        return createError("LY0521101001", message);
    }
