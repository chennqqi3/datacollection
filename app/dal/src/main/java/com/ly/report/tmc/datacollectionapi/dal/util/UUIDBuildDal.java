package com.ly.report.tmc.datacollectionapi.dal.util;
...
public class UUIDBuildDal {
    ...
    private static UUIDBuildDal uuidgen = new UUIDBuildDal();
    ...
    public static UUIDBuildDal getInstance() {
        return uuidgen;
    }
